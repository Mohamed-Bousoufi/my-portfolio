...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      "--behind-glow-color": behindGlowColor ?? "var(--primary)",
      ...
      "--sunpillar-1": "var(--primary)",
      "--sunpillar-2": "var(--secondary)",
      "--sunpillar-3": "var(--tertiary)",
      "--sunpillar-4": "var(--accent)",
      "--sunpillar-5": "var(--muted)",
      "--sunpillar-6": "var(--primary)",
          ...
          >
                  ...
                  style={
                    {
                      ...
                      left: "var(--ui-inset)",
                      right: "var(--ui-inset)",
                      background: "var(--card-info-bg, rgba(255,255,255,0.1))",
                      borderRadius:
            ...
            >
              <div
                ...
                style={{ top: "20em", display: "flex", gridArea: "auto" }}
              >
                <h3
                ...
                <p
                  ...
                  style={{
                    ...
                    margin: "0 auto",
                    backgroundImage:
                      "linear-gradient(to bottom, var(--primary-foreground), var(--accent-foreground))",
                    backgroundSize: "1em 1.5em",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    WebkitBackgroundClip: "text",
