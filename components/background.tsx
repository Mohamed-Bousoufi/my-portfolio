export default function MainBackground() {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
        <rect fill="var(--background)" width="2000" height="1500" />
        <defs>
          <rect
          ...
          <pattern
            ...
            patternTransform="rotate(80 1000 750) scale(14.45) translate(-930.8 -698.1)"
          >
            <use fill="var(--background)" href="#s" y="2" />
            <use fill="var(--background)" href="#s" x="1" y="2" />
            <use fill="var(--background)" href="#s" x="2" y="2" />
            <use fill="var(--background)" href="#s" />
            <use fill="var(--background)" href="#s" x="2" />
            <use fill="var(--background)" href="#s" x="1" y="1" />
          </pattern>
          <pattern
            id="b"
            width="7"
