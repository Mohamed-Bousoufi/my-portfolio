        ...
        <div ref={elementRef}>
            {isVisible && (
                <AnimatedContent
                    ...
                    delay={0.5}
                >
                    <div className="flex flex-col sm:flex-row-reverse items-center justify-around gap-8 min-h-[90svh] scroll-y-auto ">
                        <div className="flex-1 flex items-center justify-center min-h-[40vh] sm:min-h-30  ">
                            <ProfileCard
